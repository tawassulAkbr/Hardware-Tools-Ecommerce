...
const Checkout = () => {
  ...
  const submit = async (e) => {
    ...
    try {
      const order = await api('/orders/checkout', { method: 'POST', body: JSON.stringify({ ...Object.fromEntries(new FormData(e.currentTarget).entries()), email: auth?.user?.email }) });
