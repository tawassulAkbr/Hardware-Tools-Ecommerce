...
const products = [
  ...
  { name: 'Cut Resistant Gloves', description: 'Essential protective equipment for safer daily work.', price: 1699, stock: 100, categoryName: 'Gloves', imageUrl: asset('Safety .png') },
  { name: 'Impact Safety Helmet', description: 'Reliable protective equipment for workshop and site use.', price: 2899, stock: 100, categoryName: 'Protective Head Gear', imageUrl: asset('Safety 1.png') },
  { name: 'Full Body Harness', description: 'Durable safety equipment for demanding working conditions.', price: 4299, stock: 100, categoryName: 'Harness', imageUrl: asset('Safety 2.png') },
  { name: 'High Visibility Safety Rope', description: 'Practical safety equipment for controlled and secure work areas.', price: 3599, stock: 100, categoryName: 'Ropes', imageUrl: asset('Safety 3.png') },
  { name: 'Safety Lock Cable', description: 'Site-ready safety equipment built for reliable protection.', price: 4899, stock: 100, categoryName: 'Locks & Cables', imageUrl: asset('Safety 4.png') },
  { name: 'Steel Toe Safety Shoes', description: 'Comfortable protective equipment for long working days.', price: 6499, stock: 100, categoryName: 'Safety Shoes', imageUrl: asset('Safety 5.png') },
  { name: 'Chemical Resistant Gloves', description: 'Chemical-resistant gloves for controlled handling and site work.', price: 2199, stock: 100, categoryName: 'Chemical Gloves', imageUrl: asset('Safety 6.png') },
  { name: 'Heavy Duty Welding Gloves', description: 'Heavy-duty gloves for welding and high-temperature work.', price: 2499, stock: 100, categoryName: 'Welding Gloves', imageUrl: asset('Safety 7.png') },
  { name: 'Tinted Safety Glasses', description: 'Clear protective eyewear for workshop and construction tasks.', price: 1899, stock: 100, categoryName: 'Safety Glasses', imageUrl: asset('Safety 8.png') },
  { name: 'Welding Protection Goggles', description: 'Dark protective eyewear designed for welding environments.', price: 2799, stock: 100, categoryName: 'Welding Goggles', imageUrl: asset('Safety 9.png') },
];
